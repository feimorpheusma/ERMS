...
class ExamAction extends CommonAction
{
    ...
    public function detail()
    {
        ...
        $list = M("question q")->field("ifnull(e.qid,0) as eqid,q.id as qid,content,aA,aB,aC,aD,q.answer,q.score,q.type")->join("edu_exam_question e on e.qid=q.id and e.eid={$_GET['id']}")->where("q.cid={$cid}")->order("e.qid desc,q.id,q.type")->select();
