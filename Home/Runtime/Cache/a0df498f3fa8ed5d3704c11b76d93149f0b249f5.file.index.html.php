<?php /* Smarty version Smarty-3.1.6, created on 2016-09-29 00:58:33
...
<?php if ($_valid && !is_callable('content_57d191bf3bcc4')) {function content_57d191bf3bcc4($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'D:\\Projects\\ERMS_GIT\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
if (!is_callable('smarty_modifier_date_format')) include 'D:\\Projects\\ERMS_GIT\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
    ...
    <div class="header-navigation navbar-dynamic navbar navbar-default navbar-fixed-top loaded navbar-transparent"
         role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand animated" href=""
                   style="background:url('__PUBLIC__/images/logo-bq.png') no-repeat center"><span
                        class="animated"></span></a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav g_nav">
                    ...
                    <li><a href="__APP__/Library/index" class="btn btn-primary btn-signup animated">自测练习</a></li>
                ...
                <form class="navbar-form navbar-right" role="search" action="__APP__/Cat/show" method="GET"
                      autocompelte="off">
...
"<?php }?>
                            class="avatar_sm">　<?php echo $_SESSION['user']['username'];?>
</a>
                    </li>
...
?>
            <div class="tabcont active" onmouseover="doMouse()" onmouseout="doMouse()"
                 style="display: block; float: left; position: absolute; width: 100%; z-index: 0;">
                <div class="page-header dynamic-height"
                     style="background-image:url(__PUBLIC__/Uploads/video_first/<?php echo $_smarty_tpl->tpl_vars['three']->iteration;?>
.jpg)">
        ...
        <div class="container">
            <div class="col-md-2">
                ...
                <ul>
                    ...
                    <li><a href="__APP__/Library/index">教学资源</a></li>
                </ul>
            </div>
...
"
                                             ...
                                             src="__PUBLIC__/Uploads/videopic/<?php echo $_smarty_tpl->tpl_vars['vith']->value['picname'];?>
">
                                    </div>
                                        <span class="title"><a
                                                href="__APP__/Video/detail/id/<?php echo $_smarty_tpl->tpl_vars['vith']->value['id'];?>
...
?>
                            <div class="hot-com-list" style="height:25px">
                                <div class="hot-comment-content">
                                    <a style='width:200px;float:left;border:0px solid red'
                                       href="__APP__/Library/detail/id/<?php echo $_smarty_tpl->tpl_vars['new']->value['id'];?>
...
" style="font-size:15px; color:#FE6C6C">☞<?php echo $_smarty_tpl->tpl_vars['vo']->value['title'];?>
    ...
    <div class="home_module m_movie index_movie">
        <div class="container">
            <div class="col-md-2">
                <h2><a href="__APP__/Video/index">视频资源</a></h2>
                <ul>
                    <li><a href=""></a></li>
...
"><?php echo $_smarty_tpl->tpl_vars['vcat']->value['name'];?>
                ...
                <div class="m_pay_list">
                    <div class="tt">
                        <h3 style="color:#6C6767">点击排行榜</h3>
                        <a href="__APP__/Video/index" class="more">更多 »</a>
                    </div>
                    <ol>
...
"><?php echo $_smarty_tpl->tpl_vars['click']->value['videoname'];?>
    ...
    <div class="home_module m_review index_review">
        <div class="container">
            <div class="col-md-2">
                <h2><a href="__APP__/Library/index">文档资源</a></h2>
                <ul>
                    <li><a href="__APP__/Library/index"></a></li>
                    <li><a href="__APP__/Library/index"></a></li>
                </ul>
            </div>
            <script type="text/javascript" charset="utf-8">
...
" class="pull-left"><img
                                    alt="<?php echo $_smarty_tpl->tpl_vars['hot']->value['username'];?>
...
"><?php echo $_smarty_tpl->tpl_vars['note']->value['username'];?>
                                        ...
                                        href="__APP__/Video/detail/id/<?php echo $_smarty_tpl->tpl_vars['note']->value['vid'];?>
"><?php echo $_smarty_tpl->tpl_vars['note']->value['videoname'];?>
                                ...
                                <div class="pt5 c999 f12 review_act">
                                    <a class="btn btn-sm btn-default btn-like " data-content_id="35"
                                       data-content_type="note" href="javascript:void(0)"><i class="icon-heart"></i>
                                        <em><?php echo $_smarty_tpl->tpl_vars['note']->value['num'];?>
</em>人赞</a>
                                </div>
                            </div>
                        </li>
...
" class="pull-left"><img
                                    alt="<?php echo $_smarty_tpl->tpl_vars['notehot']->value['username'];?>
...
?>
                        ...
                        <li style='border:0px solid red;height:100px;width:50%;margin:5px 0px' class='mess_li'>
                            <h4 style='height:100px;width:80px;border-right:1px solid #ddd;float:left'><a
                                    href="__APP__/Message/index2/pid/<?php echo $_smarty_tpl->tpl_vars['vo']->value['id'];?>
...
?><p style='border:0px solid red;font:normal 13px "宋体"'><a
                                    href='__APP__/Message/show/id/<?php echo $_smarty_tpl->tpl_vars['tt']->value['id'];?>
' target='blank'>★
                                <?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['tt']->value['title'],9,'...',true);?>
</a></p><?php } ?>
...
" style='font-size:15px;color:#7C3B83;'
                                   target='blank'><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['qv']->value['content'],12,'...',true);?>
</a>
                                <p>来自用户 <a href="__APP__/Message/mine/uid/<?php echo $_smarty_tpl->tpl_vars['qv']->value['uid'];?>
" style='color:#C993D1'
                                           target='blank'><?php echo $_smarty_tpl->tpl_vars['qv']->value['username'];?>
</a></p>
                            </div>
                        </li>
                        <?php } ?>
...
"><?php echo $_smarty_tpl->tpl_vars['vo']->value['webname'];?>
            ...
            <div class="col-md-3">
                <p class="pb10">all rights reserved </p>
                <p></p>
            </div>
        </div>
    </div>
