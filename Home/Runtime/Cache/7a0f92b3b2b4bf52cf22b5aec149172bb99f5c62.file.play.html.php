<?php /* Smarty version Smarty-3.1.6, created on 2016-09-29 00:45:53
...
<head>
    ...
    <style type="text/css">
        /**弹出层效果**/
        .raceShow {
            background: url("__PUBLIC__/images/103923O21-2.gif");
            z-index: 10000;
    ...
    <script type="text/javascript" charset="utf-8">
        $(function () {
            ...
            $("#racePop").click(function (event) {
                $("#racePop").fadeOut(speed)
            });//单击弹出层则自身隐藏
    ...
    <div class="container">
        ...
        <div class="col-md-6">
            <ul class="navbar-left">
                ...
                <li class="btn-upload-w" style="margin-left:100px"><a href="javascript:void(0)" id="videoadd"
                                                                      class="btn btn-default btn-upload"><i
                        class="icon-upload-alt"></i>上传我的视频</a></li>
                <?php }else{ ?>
                <li class="btn-upload-w" style="margin-left:100px"><a href="javascript:;"
                                                                      class="btn btn-default btn-upload please"><i
                        class="icon-upload-alt"></i>上传我的视频</a></li>
                ...
                <div id="playerToolbar" class="clearfix mt20" style="padding:0 100px">
                    <div class="col-md-8 pull-left" style='width:200px;'>
                        <ul class="list_ib">
                            <li class="">
                                <?php if ($_SESSION['user']){?>
                                <i class="icon-thumbs-up" style="margin-top:15px"></i><a href="javascript:void(0)"
                                                                                         id="favo" idnum="<?php echo $_smarty_tpl->tpl_vars['vo']->value['id'];?>
"
                                                                                         title="赞"><?php if ($_smarty_tpl->tpl_vars['iszan']->value){?><font
                                    color="red">已赞</font><?php }else{ ?>赞<?php }?></a>
                                <?php }else{ ?>
                                <i class="icon-thumbs-up" style="margin-top:15px"></i><a href="javascript:void(0)"
                                                                                         class="please" title="赞">赞</a>
                                <?php }?>
                            </li>
                            <li class="v_like">
                                <?php if ($_SESSION['user']){?>
                                <i class="icon-heart" style="margin-top:15px"></i><a class="btn-like" id="collect"
                                                                                     vidnum="<?php echo $_smarty_tpl->tpl_vars['vo']->value['id'];?>
"
                                                                                     href="javascript:void(0)"
                                                                                     title="收藏"><?php if ($_smarty_tpl->tpl_vars['collect']->value){?><font
                                    color="red">已收藏</font><?php }else{ ?>收藏<?php }?></a>
                                <?php }else{ ?>
                                <i class="icon-heart" style="margin-top:15px"></i><a class="please" href="javascript:;"
                                                                                     title="收藏">收藏</a>
                                <?php }?>
                            </li>
                        </ul>
            ...
            <div class="col-md-8">
                ...
                <div class="m_show_guess slide_biquu m_cover_list mb30 feature_pay_list oh">
                    ...
                    <ul class="list_ib kandyLoop">
                        ...
                        <li id="out" onmouseover="doStop()" onmouseout="doMove()" class="tabbody"
                            style="position: relative; overflow: hidden; height: 230px; width: 700px;">
                            <div id="in" class="tabroll"
                                 style="position: absolute; width: 1000000px;hieght:240px; left: 0px;">
...
" style="width:200px"
                                                 src="__PUBLIC__/Uploads/videopic/<?php echo $_smarty_tpl->tpl_vars['li']->value['picname'];?>
">
...
" title="点击播放"
                                        ...
                                        <span class="title" style="width:200px"><a
                                                href="__URL__/detail/id/<?php echo $_smarty_tpl->tpl_vars['li']->value['id'];?>
...
" class="btn btn-sm pull-right btn-primary btn-note-new"
                           target="_blank"><i class="icon-pencil"></i> 写手记</a>
                        <?php }else{ ?>
                        <a href="javascript:;" class="btn btn-sm pull-right btn-primary btn-note-new please"><i
                                class="icon-pencil"></i> 写手记</a>
                        <?php }?>
                    </div>
...
"><?php echo $_smarty_tpl->tpl_vars['n']->value['title'];?>
                                ...
                                style="float:right">createtime：<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['n']->value['addtime'],"%Y-%m-%d %H:%M:%S");?>
</i></li>
                        <?php } ?>
...
<!--添加视频短评的弹框-->
<div id="short-review-modal" tabindex="2" style="display: none;" tabindex="-1" role="dialog"
