(function (e, Z) {
    ...
    var ia = navigator.userAgent.toLowerCase(), Ca = -1 !== ia.indexOf("mobile"), H = e.browser, qa = parseFloat(H.version), j = H.msie, ra = H.mozilla, Q = H.safari, Ra = H.opera, eb = -1 < ia.indexOf(" adobeair/");
    e.fn.xheditor = function (j) {
        ...
        this.each(function () {
            ...
            } else if (this.xheditor)n.push(this.xheditor); else {
    ...
    var $ = 0, R = !1, ta = !0, ua = !1, Sa = !1, t, aa, ba, ca, I, Da, da, Ea, Fa, Ga, J;
    ...
    var fb = {
        ...
        gb = [{n: "p", t: "\u666e\u901a\u6bb5\u843d"}, {n: "h1", t: "\u6807\u98981"}, {
            ...
            {n: "Comic Sans MS"}, {n: "Courier New"}, {n: "System"}, {n: "Times New Roman"}, {n: "Tahoma"}, {n: "Verdana"}], S = [{
            n: "x-small",
            s: "10px",
            t: "\u6781\u5c0f"
        }, {n: "small", s: "13px", t: "\u7279\u5c0f"}, {n: "medium", s: "16px", t: "\u5c0f"}, {
            n: "large",
            s: "18px",
            t: "\u4e2d"
            ...
            mini: "Bold,Italic,Underline,Strikethrough,Img",
    ...
    var lb = {a: "Link", img: "Img", embed: "Embed"}, mb = {
        ...
        function Ua(a) {
            ...
            Ia = !0;
            c.saveBookmark();
            var a = j ? "pre" : "div", m = e("<" + a + ' class="xhe-paste">\ufeff\ufeff</' + a + ">", l).appendTo(l.body), a = m[0];
            b = c.getSel();
            d = c.getRng(!0);
            ...
            setTimeout(function () {
                ...
                m.remove();
                c.loadBookmark();
                if (b = b.replace(/^[\s\uFEFF]+|[\s\uFEFF]+$/g, ""))if (a)c.pasteText(b); else if (b = c.cleanHTML(b), b = c.cleanWord(b), b = c.formatXHTML(b), !g.onPaste || g.onPaste && !1 !== (b = g.onPaste(b)))b =
                    Va(b), c.pasteHTML(b);
                Ia = !1
            }, 0)
        }
        ...
        function Va(a) {
            var b = g.localUrlTest, d = g.remoteImgSaveUrl;
            if (b && d) {
                var f = [], h = 0, a = a.replace(/(<img)((?:\s+[^>]*?)?(?:\s+src="\s*([^"]+)\s*")(?: [^>]*)?)(\/?>)/ig, function (a, d, c, e, r) {
                ...
                0 < f.length && e.post(d, {urls: f.join("|")}, function (a) {
                    a = a.split("|");
        ...
        function Ca(a) {
            ...
            c._exec("formatblock", "<p>"); else return c.pasteHTML("<br />"), j && 0 < a.length && 2 === c.getRng().parentElement().childNodes.length && c.pasteHTML("<br />"), !1
        }
        ...
        function U(a, b, d) {
            ...
            var c = d ? e('<a href="' + d + '" />')[0] : location, d = c.protocol, h = c.host, m = c.hostname, i = c.port, c = c.pathname.replace(/\\/g, "/").replace(/[^\/]+$/i, "");
            "" === i && (i = "80");
            "" === c ? c = "/" : "/" !== c.charAt(0) && (c = "/" + c);
            a = e.trim(a);
        ...
        var c = this, y = e(z), Ya = y.closest("form"), q, A, V, ea, l, fa, ma = y.offsetParent().css("zIndex"), ga, La = !1, x = !1, ka = !1, Ia = !1, Oa, na = !1, Za = "", w = null, xa, oa = !1, Pa = !1, ha = null, W = null, N = 0, g = c.settings = e.extend({}, sa.settings, n), ya = g.plugins, za = [];
        ...
        var ab = "xheCSS_" + g.skin, pa = "xhe" + $ + "_container", bb = "xhe" + $ + "_Tool", cb = "xhe" + $ + "_iframearea", db = "xhe" + $ + "_iframe", Aa = "xhe" + $ + "_fixffcursor", O = "", P = "", va = J + "xheditor_skin/" + g.skin + "/", Ba = kb, wa = g.urlType, E = g.urlBase, X = g.emotPath,
            X = X ? X : J + "xheditor_emot/", Qa = "", Ba = e.extend({}, Ba, g.emots), X = U(X, "rel", E ? E : null);
        (na = g.showBlocktag) && (P += " showBlocktag");
        var la = [];
        this.init = function () {
            0 === e("#" + ab).length && e("head").append('<link id="' + ab + '" rel="stylesheet" type="text/css" href="' + va + 'ui.css" />');
            var a = y.outerWidth(), b = y.outerHeight(), a = g.width || z.style.width || (10 < a ? a : 0);
            N = g.height || z.style.height || (10 < b ? b : 150);
            L(a, "number") && (a += "px");
            L(N, "string") && (N = N.replace(/[^\d]+/g, ""));
            var b = g.background || z.style.background, d = ['<span class="xheGStart"/>'],
                f, h, m = /\||\//i;
            e.each(g.tools, function (a, b) {
                b.match(m) && d.push('<span class="xheGEnd"/>');
                if ("|" === b)d.push('<span class="xheSeparator"/>'); else if ("/" === b)d.push("<br />"); else {
                    f = ja[b];
                    if (!f)return;
            ...
            if (a = g.loadCSS)if (L(a, "array"))for (var i in a)O += '<link rel="stylesheet" href="' + a[i] + '"/>'; else O = a.match(/\s*<style(\s+[^>]*?)?>[\s\S]+?<\/style>\s*/i) ? O + a : O + ('<link rel="stylesheet" href="' + a + '"/>');
            i = "<html><head>" + O + "<title>\u53ef\u89c6\u5316\u7f16\u8f91\u5668,alt+1\u52309\u952e,\u5207\u6362\u5230\u5de5\u5177\u533a,tab\u952e,\u9009\u62e9\u6309\u94ae,esc\u952e,\u8fd4\u56de\u7f16\u8f91 " +
            ...
            q.find(".xheButton").hover(function (a) {
                var b = e(this), d = g.hoverExecDelay, f = W;
                W = null;
            ...
            q.keydown(function (a) {
                var b = a.which;
                if (27 == b)q.find("a").attr("tabindex", "-1"), c.focus(); else if (a.altKey && 49 <= b && 57 >= b)return q.find(".xheGStart").eq(b - 49).next().find("a").focus(), !1
            });
            ...
            g.html5Upload && i.bind("dragenter dragover",
                ...
                if (a && (b = a.files) && 0 < b.length) {
                    var d, f, a = ["Link", "Img", "Flash", "Media"], i = [], k;
                    for (d in a)f = a[d], g["up" + f + "Url"] && g["up" + f + "Url"].match(/^[^!].*/i) && i.push(f + ":," + g["up" + f + "Ext"]);
                    if (0 === i.length)return !1;
                    k = i.join(",");
                    f = function (a) {
                        var b, c;
                        for (d = 0; d < a.length; d++)if (b = a[d].name.replace(/.+\./, ""), b = k.match(RegExp("(\\w+):[^:]*," + b + "(?:,|$)",
                                "i")))if (c) {
                            if (c !== b[1])return 2
                        } else c = b[1]; else return 1;
                        return c
                    }(b);
                    1 === f ? alert("\u4e0a\u4f20\u6587\u4ef6\u7684\u6269\u5c55\u540d\u5fc5\u9700\u4e3a\uff1a" + k.replace(/\w+:,/g, "")) : 2 === f ? alert("\u6bcf\u6b21\u53ea\u80fd\u62d6\u653e\u4e0a\u4f20\u540c\u4e00\u7c7b\u578b\u6587\u4ef6") : f && c.startUpload(b, g["up" + f + "Url"], "*", function (a) {
                        var b = [], d;
                        (d = g.onUpload) && d(a);
            ...
            (i = g.shortcuts) && e.each(i, function (a, b) {
                c.addShortcuts(a, b)
            });
            $++;
            La = !0;
        ...
        this.setTextCursor =
            function (a) {
                var b = c.getRng(!0), d = l.body;
                if (j)b.moveToElementText(d); else {
        ...
        this.getSelect = function (a) {
            var b = c.getSel(), d = c.getRng(), f = !0, f = !d || d.item ? !1 : !b || 0 === d.boundingWidth || d.collapsed;
        ...
        this.pasteHTML = function (a, b) {
            if (x)return !1;
            c.focus();
            var a = c.processHTML(a, "write"), d = c.getSel(), f = c.getRng();
            if (b !== Z) {
                if (f.item) {
        ...
        this.processHTML = function (a,
                                     b) {
            if ("write" === b) {
                a = a.replace(/(<(\/?)(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*((\/?)>)/g, function (a, b, c, d, e, f, h) {
                    d = d.toLowerCase();
                    ...
                    if ("del" === d)d = "strike"; else if ("img" === d)e = e.replace(/\s+emot\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i, function (a, b) {
                        ...
                        "default" === p[0] && (p[0] = "");
                        return g.emotMark ? a : ""
                    }); else if ("a" === d)!e.match(/ href=[^ ]/i) && e.match(/ name=[^ ]/i) && (D += " xhe-anchor"), h && (f = "></a>"); else if ("table" === d && !c && (a = e.match(/\s+border\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i), !a || a[1].match(/^(["']?)\s*0\s*\1$/)))D += " xhe-border";
                    ...
                    p && (a = X + (p[0] ? p[0] : "default") + "/" + p[1] + ".gif", e += ' src="' +
                        a + '" _xhe_src="' + a + '"');
                ...
                if (Q)for (var e = [{
                    ...
                    t: "u"
                }, {r: /text-decoration:\sline-through/ig, t: "strike"}], c = function (a, b, c, d, h) {
                    b = c + d;
                    c = "";
                    if (!b)return h;
        ...
        this.cleanWord = function (a) {
            var b = g.cleanPaste;
            if (0 < b && 3 > b && a.match(/mso(-|normal)|WordDocument|<table\s+[^>]*?x:str/i))for (var a = a.replace(/<\!--[\s\S]*?--\>|<!(--)?\[[\s\S]+?\](--)?>|<style(\s+[^>]*?)?>[\s\S]*?<\/style>/ig,
        ...
        this.formatXHTML = function (a, b) {
            ...
            function g(a) {
                if (a)for (b = C.length - 1; 0 <= b && !(C[b] === a); b--); else var b = 0;
                if (0 <= b) {
            ...
            function u(a, c, d) {
                A || (a = a.replace(/(\t*\r?\n\t*)+/g, ""));
                if (!A &&
                    !0 === b)if (a.match(/^\s*$/))G.push(a); else {
                    var e = p[c];
                    e ? (d && w++, "" === y && w--) : y && w++;
                    ((e ? c : "") !== y || e) && r();
                    G.push(a);
            ...
            var F = d("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"), p = d("address,applet,blockquote,button,center,dd,dir,div,dl,dt,fieldset,form,frameset,h1,h2,h3,h4,h5,h6,hr,iframe,ins,isindex,li,map,menu,noframes,noscript,object,ol,p,pre,table,tbody,td,tfoot,th,thead,tr,ul,script"), D = d("a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"),
                Y = d("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr"), l = d("checked,compact,declare,defer,disabled,ismap,multiple,nohref,noresize,noshade,nowrap,readonly,selected"), j = d("script,style"), n = {
                    b: "strong",
                    i: "em",
                    s: "del",
                    strike: "del"
                }, q = /<(?:\/([^\s>]+)|!([^>]*?)|([\w\-:]+)((?:"[^"]*"|'[^']*'|[^"'<>])*)\s*(\/?))>/g, x = /\s*([\w\-:]+)(?:\s*=\s*(?:"([^"]*)"|'([^']*)'|([^\s]+)))?/g, G = [], C = [];
            C.last = function () {
        ...
        this.toggleSource = function (a) {
            if (x !== a) {
                ...
                var b = l.body, d = e(b), f, h, a = 0, g = "";
                if (x)f = c.getSource(), d.html("").removeAttr("scroll").attr("class",
                    "editMode" + P), j ? b.contentEditable = "true" : l.designMode = "On", ra && (c._exec("inserthtml", "-"), e("#" + Aa).show().focus().hide()), g = "\u6e90\u4ee3\u7801"; else {
        ...
        this.showPreview = function () {
            ...
            a && (b = a(b));
            var a = "<html><head>" + O + "<title>\u9884\u89c8</title>" + (E ? '<base href="' + E + '"/>' : "") + "</head><body>" + b + "</body></html>", b = window.screen, b = window.open("", "xhePreview", "toolbar=yes,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=" + Math.round(0.9 * b.width) + ",height=" + Math.round(0.8 * b.height) + ",left=" + Math.round(0.05 * b.width)), d = b.document;
            d.open();
            d.write(a);
            d.close();
            b.focus()
        ...
        this.toggleFullscreen = function (a) {
            if (ka !== a) {
                var a = e("#" + pa).find(".xheLayout"), b = e("#" + pa), d = jQuery.browser.version, d = j && (6 == d || 7 == d);
        ...
        this.showMenu = function (a, b) {
            var d = e('<div class="xheMenu"></div>'), f = a.length, h = [];
        ...
        this.showColor = function (a) {
            var b = e('<div class="xheColor"></div>'), d = [], f = Ta.length, h = 0;
        ...
        this.showLink = function () {
            var a = '<div><label for="xheLinkUrl">\u94fe\u63a5\u5730\u5740: </label><input type="text" id="xheLinkUrl" value="http://" class="xheText" /></div><div><label for="xheLinkTarget">\u6253\u5f00\u65b9\u5f0f: </label><select id="xheLinkTarget"><option selected="selected" value="">\u9ed8\u8ba4</option><option value="_blank">\u65b0\u7a97\u53e3</option><option value="_self">\u5f53\u524d\u7a97\u53e3</option><option value="_parent">\u7236\u7a97\u53e3</option></select></div><div style="display:none"><label for="xheLinkText">\u94fe\u63a5\u6587\u5b57: </label><input type="text" id="xheLinkText" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="\u786e\u5b9a" /></div>',
                b = fa.find("a[name]").not("[href]"), d = 0 < b.length;
            if (d) {
                var f = [];
                b.each(function () {
            ...
            var a = e(a), h = c.getParent("a"), m = e("#xheLinkText", a), i = e("#xheLinkUrl", a), k = e("#xheLinkTarget", a), b = e("#xheSave", a), u = c.getSelect();
            ...
            b.click(function () {
                ...
                if ("" !== a && "http://" !== a) {
                    var b = a.split(" "), d = k.val(), f = m.val();
                    if (1 < b.length) {
                        c._exec("unlink");
                        u = c.getSelect();
                        var g = '<a href="xhe_tmpurl"', Y = [];
                        "" !== d && (g += ' target="' + d + '"');
                        ...
                        c.pasteHTML(Y.join("&nbsp;"))
                    } else a = b[0].split("||"), f || (f = a[0]), f = a[1] ? a[1] : "" !== u ? "" : f ? f : a[0], 0 === h.length ? (f ? c.pasteHTML('<a href="#xhe_tmpurl">' + f + "</a>") : c._exec("createlink", "#xhe_tmpurl"), h = e('a[href$="#xhe_tmpurl"]', l)) : f && !Q && h.text(f), K(h, "href", a[0]), "" !== d ? h.attr("target", d) : h.removeAttr("target")
                }
                c.hidePanel();
                return !1
            });
        ...
        this.showAnchor = function () {
            var a = e('<div><label for="xheAnchorName">\u951a\u70b9\u540d\u79f0: </label><input type="text" id="xheAnchorName" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="\u786e\u5b9a" /></div>'), b = c.getParent("a"), d = e("#xheAnchorName", a), f = e("#xheSave", a);
            if (1 === b.length) {
                if (b.attr("href"))return w =
                    null, c.exec("Link");
                d.val(b.attr("name"))
            }
            f.click(function () {
        ...
        this.showImg = function () {
            var a = e('<div><label for="xheImgUrl">\u56fe\u7247\u6587\u4ef6: </label><input type="text" id="xheImgUrl" value="http://" class="xheText" /></div><div><div style="display: none"><label for="xheImgAlt">\u66ff\u6362\u6587\u672c: </label><input type="text" id="xheImgAlt" /></div><div style="display: none"><label for="xheImgAlign">\u5bf9\u9f50\u65b9\u5f0f: </label><select id="xheImgAlign"><option selected="selected" value="">\u9ed8\u8ba4</option><option value="left">\u5de6\u5bf9\u9f50</option><option value="right">\u53f3\u5bf9\u9f50</option><option value="top">\u9876\u7aef</option><option value="middle">\u5c45\u4e2d</option><option value="baseline">\u57fa\u7ebf</option><option value="bottom">\u5e95\u8fb9</option></select></div><div><label for="xheImgWidth">\u5bbd\u3000\u3000\u5ea6: </label><input type="text" id="xheImgWidth" style="width:40px;" /> <label for="xheImgHeight">\u9ad8\u3000\u3000\u5ea6: </label><input type="text" id="xheImgHeight" style="width:40px;" /></div><div style="display: none"><label for="xheImgBorder">\u8fb9\u6846\u5927\u5c0f: </label><input type="text" id="xheImgBorder" style="width:40px;" /></div><div style="display: none"><label for="xheImgHspace">\u6c34\u5e73\u95f4\u8ddd: </label><input type="text" id="xheImgHspace" style="width:40px;" /> <label for="xheImgVspace">\u5782\u76f4\u95f4\u8ddd: </label><input type="text" id="xheImgVspace" style="width:40px;" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="\u786e\u5b9a" /></div>'),
                b = c.getParent("img"), d = e("#xheImgUrl", a), f = e("#xheImgAlt", a), h = e("#xheImgAlign", a), m = e("#xheImgWidth", a), i = e("#xheImgHeight", a), k = e("#xheImgBorder", a), u = e("#xheImgVspace", a), r = e("#xheImgHspace", a), s = e("#xheSave", a);
            if (1 === b.length) {
                d.val(K(b, "src"));
                f.val(b.attr("alt"));
                h.val(b.attr("align"));
                ...
                i.val(b.attr("height"));
                k.val(b.attr("border"));
                var F = b.attr("vspace"), p = b.attr("hspace");
                u.val(0 >= F ? "" : F);
                r.val(0 >= p ? "" : p)
            }
            ...
            s.click(function () {
                ...
                var a = d.val();
                if ("" !== a && "http://" !== a) {
                    var g = a.split(" "), p = f.val(), s = h.val(), F = m.val(), j = i.val(), n = k.val(), o = u.val(), q = r.val();
                    if (1 < g.length) {
        ...
        this.showEmbed = function (a, b, d, f, g, m, i) {
            var b = e(b), k = c.getParent('embed[type="' + d + '"],embed[classid="' + f + '"]'), u = e("#xhe" + a + "Url", b), r = e("#xhe" + a + "Width", b), s = e("#xhe" + a + "Height", b), a = e("#xheSave", b);
            ...
            a.click(function () {
                ...
                var a = u.val();
                if ("" !== a && "http://" !== a) {
                    var b = r.val(), i = s.val(), m = /^\d+%?$/;
                    m.test(b) || (b = 412);
                    m.test(i) || (i = 300);
                    var j = '<embed type="' + d + '" classid="' + f + '" src="xhe_tmpurl"' + g, m = a.split(" ");
                    if (1 < m.length) {
                        var n, o = [], j = j + ' width="xhe_width" height="xhe_height" />', q;
        ...
        this.showEmot = function (a) {
            var b = e('<div class="xheEmot"></div>'), a = a ? a : Qa ? Qa : "default", d = Ba[a], f = X + a + "/", g = 0, m = [], i = "", i = d.width, k = d.height, u = d.line,
                r = d.count, d = d.list;
            if (r)for (d = 1; d <= r; d++)g++, m.push("<a href=\"javascript:void('" + d + '\')" style="background-image:url(' + f + d + '.gif);" emot="' + a + "," + d + '" xhev="" title="' + d + '" role="option">&nbsp;</a>'), 0 === g % u && m.push("<br />"); else e.each(d, function (b, c) {
                g++;
                m.push("<a href=\"javascript:void('" + c + '\')" style="background-image:url(' + f + b + '.gif);" emot="' + a + "," + b + '" title="' + c + '" xhev="' + c + '" role="option">&nbsp;</a>');
                0 === g % u && m.push("<br />")
            });
            var r = u * (i + 12), d = Math.ceil(g / u) * (k + 12), s = 0.75 * r;
            d <= s &&
            (s = "");
        ...
        this.showTable = function () {
            var a = e('<div><label for="xheTableRows">\u884c\u3000\u3000\u6570: </label><input type="text" id="xheTableRows" style="width:40px;" value="3" /> <label for="xheTableColumns">\u5217\u3000\u3000\u6570: </label><input type="text" id="xheTableColumns" style="width:40px;" value="2" /></div><div><label for="xheTableHeaders">\u6807\u9898\u5355\u5143: </label><select id="xheTableHeaders"><option selected="selected" value="">\u65e0</option><option value="row">\u7b2c\u4e00\u884c</option><option value="col">\u7b2c\u4e00\u5217</option><option value="both">\u7b2c\u4e00\u884c\u548c\u7b2c\u4e00\u5217</option></select></div><div><label for="xheTableWidth">\u5bbd\u3000\u3000\u5ea6: </label><input type="text" id="xheTableWidth" style="width:40px;" value="200" /> <label for="xheTableHeight">\u9ad8\u3000\u3000\u5ea6: </label><input type="text" id="xheTableHeight" style="width:40px;" value="" /></div><div><label for="xheTableBorder">\u8fb9\u6846\u5927\u5c0f: </label><input type="text" id="xheTableBorder" style="width:40px;" value="1" /></div><div><label for="xheTableCellSpacing">\u8868\u683c\u95f4\u8ddd: </label><input type="text" id="xheTableCellSpacing" style="width:40px;" value="1" /> <label for="xheTableCellPadding">\u8868\u683c\u586b\u5145: </label><input type="text" id="xheTableCellPadding" style="width:40px;" value="1" /></div><div><label for="xheTableAlign">\u5bf9\u9f50\u65b9\u5f0f: </label><select id="xheTableAlign"><option selected="selected" value="">\u9ed8\u8ba4</option><option value="left">\u5de6\u5bf9\u9f50</option><option value="center">\u5c45\u4e2d</option><option value="right">\u53f3\u5bf9\u9f50</option></select></div><div><label for="xheTableCaption">\u8868\u683c\u6807\u9898: </label><input type="text" id="xheTableCaption" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="\u786e\u5b9a" /></div>'),
                b = e("#xheTableRows", a), d = e("#xheTableColumns", a), f = e("#xheTableHeaders", a), g = e("#xheTableWidth", a), m = e("#xheTableHeight", a), i = e("#xheTableBorder", a), k = e("#xheTableCellSpacing", a), u = e("#xheTableCellPadding", a), r = e("#xheTableAlign", a), s = e("#xheTableCaption", a);
            e("#xheSave", a).click(function () {
                c.loadBookmark();
                var a = s.val(), e = i.val(), j = b.val(), l = d.val(), n = f.val(), o = g.val(), q = m.val(), t = k.val(), w = u.val(), z = r.val(), e = "<table" + ("" !== e ? ' border="' + e + '"' : "") + ("" !== o ? ' width="' + o + '"' : "") + ("" !== q ? ' height="' +
        ...
        this.uploadInit = function (a, b, d) {
            ...
            var h = e('<span class="xheUpload"><input type="text" style="visibility:hidden;" tabindex="-1" /><input type="button" value="' + g.upBtnText + '" class="xheBtn" tabindex="-1" /></span>'), m = e(".xheBtn", h), i = g.html5Upload, k = i ? g.upMultiple : 1;
            a.after(h);
            m.before(a);
        ...
        this.startUpload = function (a, b, d, f) {
            ...
            var m = [], i = g.html5Upload, k = i ? g.upMultiple : 1, j, r = e('<div style="padding:22px 0;text-align:center;line-height:30px;">\u6587\u4ef6\u4e0a\u4f20\u4e2d\uff0c\u8bf7\u7a0d\u5019\u2026\u2026<br /></div>'), s = '<img src="' + va + 'img/loading.gif">';
        ...
        this.html4Upload = function (a, b,
                                     c) {
            var f = "jUploadFrame" + (new Date).getTime(), g = this, j = e('<iframe name="' + f + '" class="xheHideArea" />').appendTo("body"), i = e('<form action="' + b + '" target="' + f + '" method="post" enctype="multipart/form-data" class="xheHideArea"></form>').appendTo("body"), k = e(a), l = k.clone().attr("disabled", "true");
            k.before(l).appendTo(i);
            this.remove = function () {
                null !== g && (l.before(k).remove(), j.remove(), i.remove(), g = null)
            };
            this.onLoad = function () {
                var a = j[0].contentWindow.document, b = e(a.body).text();
                a.write("");
                g.remove();
                c(b, !0)
            };
        ...
        this.html5Upload = function (a, b, c, e, g) {
            ...
            function i(a) {
                g && g({loaded: s + a, total: n})
            }

            for (var k, l = 0, r = b.length, s = 0, n = 0, p = this, o = 0; o < r; o++)n += b[o].size;
            this.remove = function () {
                k && (k.abort(), k = null)
            };
        ...
        this.showIframeModal = function (a, b, d, f, g, j) {
            function i() {
                try {
                    s.callback = k, s.unloadme = c.removeModal, e(s.document).keydown(H),
                        n = s.name
                } catch (a) {
                }
            }
            ...
            var b = e('<iframe frameborder="0" src="' + b.replace(/{editorRoot}/ig, J) + (/\?/.test(b) ? "&" : "?") + "parenthost=" + location.host + '" style="width:100%;height:100%;display:none;" /><div class="xheModalIfmWait"></div>'), l = b.eq(0), r = b.eq(1);
            c.showModal(a, b, f, g, j);
            var s = l[0].contentWindow, n;
            i();
            l.load(function () {
                i();
                if (n) {
        ...
        this.showDialog = function (a, b) {
            var d = e('<div class="xheDialog"></div>'), f = e(a), h = e("#xheSave", f);
            if (1 === h.length) {
                f.find("input[type=text],select").keypress(function (a) {
                    if (13 ===
                        a.which)return h.click(), !1
                });
                ...
                if (!g.clickCancelDialog) {
                    ta = !1;
                    var j = e('<div class="xheFixCancel"></div>').appendTo("body").mousedown(M), i = A.offset();
                    j.css({left: i.left, top: i.top, width: A.outerWidth(), height: A.outerHeight()})
                }
        ...
        this.showPanel = function (a,
            ...
            var c = ca.offset(), f = c.left, c = c.top, c = c + (ca.outerHeight() - 1);
            ba.css({left: f + 1, top: c, width: ca.width()}).show();
            ...
            h = g.layerShadow;
            0 < h && aa.css({left: f + h, top: c + h, width: t.outerWidth(), height: t.outerHeight()}).show();
        ...
        this.exec =
            function (a) {
                ...
                if (b.e)b.e.call(c); else switch (a = a.toLowerCase(), a) {
                    case "cut":
                        try {
                    ...
                    case "copy":
                        try {
                            if (l.execCommand(a),
                                    !l.queryCommandSupported(a))throw"Error";
                        } catch (h) {
                    ...
                    case "blocktag":
                        ...
                        e.each(gb, function (a, b) {
                            i.push({s: "<" + b.n + ">" + b.t + "</" + b.n + ">", v: "<" + b.n + ">", t: b.t})
                        });
                    ...
                    case "fontface":
                        ...
                        e.each(hb, function (a, b) {
                            b.c = b.c ? b.c : b.n;
                            k.push({s: '<span style="font-family:' + b.c + '">' + b.n + "</span>", v: b.c, t: b.n})
                        });
    ...
    e(function () {
        ...
        e("textarea").each(function () {
            var j = e(this), n = j.attr("class");
            if (n && (n = n.match(/(?:^|\s)xheditor(?:\-(m?full|simple|mini))?(?:\s|$)/i)))j.xheditor(n[1] ? {tools: n[1]} : null)
        })
    })
})(jQuery);
